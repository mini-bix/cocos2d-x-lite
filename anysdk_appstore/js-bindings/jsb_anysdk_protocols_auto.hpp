...
bool js_anysdk_framework_PluginProtocol_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_PluginFactory_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_PluginManager_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_ProtocolAnalytics_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_ProtocolYAP_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
void register_all_anysdk_framework(JSContext* cx, JS::HandleObject obj);
bool js_anysdk_framework_ProtocolYAP_getPluginId(JSContext *cx, uint32_t argc, jsval *vp);
bool js_anysdk_framework_ProtocolYAP_getOrderId(JSContext *cx, uint32_t argc, jsval *vp);
bool js_anysdk_framework_ProtocolYAP_resetYapState(JSContext *cx, uint32_t argc, jsval *vp);

extern JSClass  *jsb_anysdk_framework_ProtocolAds_class;
extern JSObject *jsb_anysdk_framework_ProtocolAds_prototype;

bool js_anysdk_framework_ProtocolAds_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_ProtocolSocial_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_ProtocolUser_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_ProtocolPush_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_ProtocolCrash_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_ProtocolREC_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_ProtocolCustom_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_ProtocolAdTracking_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
void register_all_anysdk_framework(JSContext* cx, JS::HandleObject obj);
bool js_anysdk_framework_ProtocolAdTracking_onYap(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_AgentManager_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_anysdk_framework_JSBRelation_constructor(JSContext *cx, uint32_t argc, jsval *vp);
