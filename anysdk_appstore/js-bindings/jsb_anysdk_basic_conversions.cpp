...
bool jsval_to_TYAPDeveloperInfo(JSContext *cx, JS::HandleValue v, TYAPDeveloperInfo* ret)
{
...
bool jsval_to_TYapmentInfo(JSContext *cx, JS::HandleValue v, std::map<std::string, std::string>* ret)
{
    return jsval_to_TProductInfo(cx, v, ret);
}
