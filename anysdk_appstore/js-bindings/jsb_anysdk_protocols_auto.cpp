...
bool js_anysdk_framework_ProtocolYAP_getPluginId(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_anysdk_framework_ProtocolYAP_getPluginId : wrong number of arguments: %d, was expecting %d", argc, 0);
    return false;
}
bool js_anysdk_framework_ProtocolYAP_getOrderId(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_anysdk_framework_ProtocolYAP_getOrderId : wrong number of arguments: %d, was expecting %d", argc, 0);
    return false;
}
bool js_anysdk_framework_ProtocolYAP_resetYapState(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_anysdk_framework_ProtocolYAP_resetYapState : wrong number of arguments");
    return false;
}
...
void js_register_anysdk_framework_ProtocolYAP(JSContext *cx, JS::HandleObject global) {
    jsb_anysdk_framework_ProtocolYAP_class = (JSClass *)calloc(1, sizeof(JSClass));
    jsb_anysdk_framework_ProtocolYAP_class->name = "ProtocolYAP";
    jsb_anysdk_framework_ProtocolYAP_class->addProperty = JS_PropertyStub;
    jsb_anysdk_framework_ProtocolYAP_class->delProperty = JS_DeletePropertyStub;
    jsb_anysdk_framework_ProtocolYAP_class->getProperty = JS_PropertyStub;
    jsb_anysdk_framework_ProtocolYAP_class->setProperty = JS_StrictPropertyStub;
    jsb_anysdk_framework_ProtocolYAP_class->enumerate = JS_EnumerateStub;
    jsb_anysdk_framework_ProtocolYAP_class->resolve = JS_ResolveStub;
    jsb_anysdk_framework_ProtocolYAP_class->convert = JS_ConvertStub;
    jsb_anysdk_framework_ProtocolYAP_class->flags = JSCLASS_HAS_RESERVED_SLOTS(2);
    ...
    JS::RootedValue className(cx, std_string_to_jsval(cx, "ProtocolYAP"));
    JS_SetProperty(cx, proto, "_className", className);
    JS_SetProperty(cx, proto, "__nativeObj", JS::TrueHandleValue);
    JS_SetProperty(cx, proto, "__is_ref", JS::FalseHandleValue);
    // add the proto and JSClass to the type->js info hash table
    jsb_register_class<anysdk::framework::ProtocolYAP>(cx, jsb_anysdk_framework_ProtocolYAP_class, proto, parent_proto);
}
...
bool js_anysdk_framework_ProtocolAdTracking_onYap(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_anysdk_framework_ProtocolAdTracking_onYap : wrong number of arguments: %d, was expecting %d", argc, 1);
    return false;
}
