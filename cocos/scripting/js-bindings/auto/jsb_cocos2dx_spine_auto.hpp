...
extern JS::PersistentRootedObject *jsb_spine_SkeletonCache_prototype;
...
bool js_cocos2dx_spine_SkeletonCache_SkeletonCache(JSContext *cx, uint32_t argc, JS::Value *vp);
