...
extern JS::PersistentRootedObject *jsb_baiyou_BaiyouPlugin_prototype;

bool js_baiyou_plugin_BaiyouPlugin_constructor(JSContext *cx, uint32_t argc, JS::Value *vp);
